export const copy = {
  pt: {
    ...
    hero: {
      ...
      highlights: [
        "Grow+ Studio — Sua marca, conteúdos que impactam e sistemas que vendem.",
        "Transformamos sua presença digital em resultados tangíveis, com conteúdo criativo e tecnologia estratégica.",
        "Cresça com inteligência. Cresça com conteúdo. Cresça com sistema.",
      ],
    },
    trust: {
  ...
  en: {
    ...
    hero: {
      ...
      subtext:
        "We build digital presence, cinematic content and scalable systems for brands ready to grow.",
      ctaPrimary: "Get in touch",
      ctaSecondary: "See our work",
      highlights: [
        "Grow+ Studio — Your brand, content that impacts and systems that sell.",
        "We turn your digital presence into tangible results with creative content and strategic technology.",
        "Grow with intelligence. Grow with content. Grow with systems.",
      ],
    },
    trust: {
      eyebrow: "Trusted by",
